...
func controllerPublishVolume(
	...
	// execute the rpc
	result, err := ControllerPublishVolume(
...
func getNodeID(
	...
	// execute the rpc
	if nodeID, err = GetNodeID(ctx, client, version); err != nil {
		return err
	}
...
func getSupportedVersions(
	...
	// execute the rpc
	versions, err := GetSupportedVersions(ctx, client)
	if err != nil {
		return err
	}
...
func getPluginInfo(
	...
	// execute the rpc
	info, err := GetPluginInfo(ctx, client, args.version)
	if err != nil {
		return err
	}
...
func controllerGetCapabilities(
	...
	// execute the rpc
	caps, err := ControllerGetCapabilities(ctx, client, args.version)
	if err != nil {
		return err
	}
